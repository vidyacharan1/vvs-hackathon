  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
      {kpiData.map((kpi, idx) => {
        const Icon = kpi.icon;
        return (
          <div key={kpi.label} className="card p-4 hover:scale-[1.01] cursor-default" style={{ animationDelay: `${idx * 80}ms` }}>
            ...
            <div className="flex items-end justify-between">
              ...
              <span className={`flex items-center gap-1 text-[11px] font-medium ${kpi.trendColor} ${kpi.badgeBg} px-2 py-0.5 rounded-full border`}>
